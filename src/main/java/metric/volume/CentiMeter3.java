...
public class CentiMeter3 implements Volume {
    private BigDecimal value;

    protected CentiMeter3(final BigDecimal value) {
        this.value = value;
    }
    ...
    public String toString() {
        return String.format("%s Centimeter3", value);
    }
    ...
    public CentiMeter3 toCentiMeter3() {
        return Volume.centimeter3(value);
    }
    ...
    public Volume add(final Volume volume) {
        this.value = this.value.add(volume.toCentiMeter3().getValue());
        return this;
    }

    @Override
    public Volume subtract(final Volume volume) {
        this.value = this.value.subtract(volume.toCentiMeter3().getValue());
        return this;
    }
