...
public class HectoMeter3 implements Volume {
    private BigDecimal value;

    protected HectoMeter3(final BigDecimal value) {
        this.value = value;
    }
    ...
    public MilliMeter3 toMilliMeter3() {
        return Volume.millimeter3(this.multiply(BigDecimal.valueOf(Math.pow(10, 15))).getValue());
    }

    @Override
    public CentiMeter3 toCentiMeter3() {
        return Volume.centimeter3(this.multiply(BigDecimal.valueOf(Math.pow(10, 12))).getValue());
    }

    @Override
    public DeciMeter3 toDeciMeter3() {
        return Volume.decimeter3(this.multiply(BigDecimal.valueOf(Math.pow(10, 9))).getValue());
    }

    @Override
    public Meter3 toMeter3() {
        return Volume.meter3(this.multiply(BigDecimal.valueOf(Math.pow(10, 6))).getValue());
    }

    @Override
    public DecaMeter3 toDecaMeter3() {
        return Volume.decameter3(this.multiply(BigDecimal.valueOf(Math.pow(10, 3))).getValue());
    }

    @Override
    public HectoMeter3 toHectoMeter3() {
        return Volume.hectometer3(value);
    }

    @Override
    public KiloMeter3 toKiloMeter3() {
        return Volume.kilometer3(this.divide(BigDecimal.valueOf(Math.pow(10, 3))).getValue());
    }
